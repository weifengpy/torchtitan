...
Requires 2+ GPUs. Run with:
    pytest torchtitan/experiments/flex_shard/tests/test_checkpoint.py -x
"""
...
from torchtitan.experiments.flex_shard import BucketSpec, flex_shard, Shard
...
class TestFlexShardCheckpoint(FSDPTest):
    ...
    def test_flex_shard_roundtrip(self):
        ...
        # Train original
        flex_shard(model, mesh, shard_placement_fn={"*": Shard(0)})
        ...
        flex_shard(model2, mesh, shard_placement_fn={"*": Shard(0)})
